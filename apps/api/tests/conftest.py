...
os.environ.setdefault("DATABASE_URL", "postgresql+asyncpg://perfectday:perfectday@localhost:5432/perfectday_test")
os.environ.setdefault("DATABASE_URL_SYNC", "postgresql://perfectday:perfectday@localhost:5432/perfectday_test")
